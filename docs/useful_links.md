...
#### Introduction:
- [gRPC vs REST, что выбрать для нового сервера? (Хабр)](https://habr-com.cdn.ampproject.org/v/s/habr.com/ru/amp/post/565020/?amp_gsa=1&amp_js_v=a9&usqp=mq331AQKKAFQArABIIACAw==#amp_tf=Источник: %1$s&aoh=16745491590478&referrer=https://www.google.com&ampshare=https://habr.com/ru/post/565020/)
...
- [Как создать простой микросервис на Golang и gRPC и выполнить его контейнеризацию с помощью Docker (Хабр)](https://habr.com/ru/post/461279/)
