...
docker exec yandex-tank yandex-tank -c line_load_rps.yaml ammo.txt
docker exec yandex-tank yandex-tank -c const_load_rps.yaml ammo.txt
docker exec yandex-tank yandex-tank -c const_load_instances.yaml ammo.txt
